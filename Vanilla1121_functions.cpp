...
HWND vanilla1121_gameWindow() {
    typedef HWND(__fastcall* GETGAMEWINDOW)(int);
    auto p_getGameWindow = reinterpret_cast<GETGAMEWINDOW>(0x435c30);
...
C3Vector vanilla1121_worldToScreen(C3Vector& world) {
    ...
    typedef void(__fastcall* DDCTONDC)(float*, float*, float, float);
